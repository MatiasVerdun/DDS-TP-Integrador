...
<div class="wrapper ">
  <div id="formContent">
   <form action="MenuMetodologiaControllerServlet" method="post">
    ...
    <input type="submit" class="fadeIn "  name="cargarMetodologia" value="Cargar Metodologia">
   <input type="submit" class="fadeIn "  name="usarMetodologia" value="Usar Metodologia">
        <input type="submit" class="fadeIn "  name="usarMetodologiaEmpresas" value="Usar en todas las Empresas">
