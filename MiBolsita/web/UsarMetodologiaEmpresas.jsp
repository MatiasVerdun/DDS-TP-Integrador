...
<br>
<br>
  <input class="button" type="submit" name="usarMetodologia" value="Aplicar en todas las Empresas">
...
if (metodologiaConCondiciones != null ){
    ...
    for (int counter = 0; counter < empresas.size(); counter++) { 		      
        ...
        out.print("</td>");
        out.print("<td>");
        if(metodologiaConCondiciones.pasaCondiciones(empresaActual,desde, hasta)){
        out.print(" Es seguro invertir");}else{out.print(" No es seguro invertir");}
        out.print("</td>");
        out.print("</tr>");
    }
    out.print("</table>");}
