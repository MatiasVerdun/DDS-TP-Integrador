...
ArrayList<Indicador> indicadores2 =(ArrayList<Indicador>)request.getSession().getAttribute("indicadoresBean");  

for (int counter = 0; counter < indicadores2.size(); counter++) { 		      
    out.print("<option value='"); 		
    out.print(indicadores2.get(counter).getNombre()); 		
    out.print("' ");
/*
