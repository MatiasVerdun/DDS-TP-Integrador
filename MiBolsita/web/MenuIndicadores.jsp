...
<div class="wrapper">
  <div id="formContent">
   <form action="MenuIndicadoresControllerServlet" method="post">
    ...
    <input type="submit" class="fadeIn "  name="cargarIndicador" value="Cargar Indicador">
   <input type="submit" class="fadeIn "  name="verIndicador" value="Ver Indicador">
        <input type="submit" class="fadeIn "  name="usarIndicador" value="Usar Indicador">
